...
- [Inspect Task](core/inspect-task.md)
...
- [Check Boundaries](architecture/check-boundaries.md)
...
- [Remove Dead Code](coding/remove-dead-code.md)
- [Improve Error Handling](coding/improve-error-handling.md)

## Testing

- [Find Test Entrypoints](testing/find-test-entrypoints.md)
- [Add Unit Tests](testing/add-unit-tests.md)
- [Add Integration Tests](testing/add-integration-tests.md)
