 ...
 * Compiled as C++ so COM interfaces use obj->Method() syntax.
 */
#include <windows.h>
#include <d2d1.h>
#include <dwrite.h>
...
Color4F renderer_rgb_to_color(uint32_t rgb) {
    Color4F c;
    c.r=((rgb>>16)&0xFF)/255.0f; c.g=((rgb>>8)&0xFF)/255.0f;
...
static bool create_rt(Renderer *r) {
    ...
    hp.hwnd=r->hwnd; hp.pixelSize=sz; hp.presentOptions=D2D1_PRESENT_OPTIONS_NONE;
